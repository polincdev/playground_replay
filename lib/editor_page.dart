    ...
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Expanded(child: Text(_subject, style: Theme.of(context).textTheme.bodyText1)),
          IconButton(
            onPressed: () => Navigator.of(context).pop(),
            icon: Image.asset(
    ...
    return PopupMenuButton<String>(
      ...
      itemBuilder: (BuildContext context) => <PopupMenuItem<String>>[
            PopupMenuItem<String>(
              ...
              child: Text('from.jennifer@example.com', style: Theme.of(context).textTheme.subtitle1),
            ),
            PopupMenuItem<String>(
              value: 'hey@phantom.works',
              child: Text('hey@phantom.works', style: Theme.of(context).textTheme.subtitle1),
            ),
          ],
      child: Padding(
        ...
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: <Widget>[
            Expanded(child: Text(_senderEmail, style: Theme.of(context).textTheme.subtitle1)),
            const Icon(
